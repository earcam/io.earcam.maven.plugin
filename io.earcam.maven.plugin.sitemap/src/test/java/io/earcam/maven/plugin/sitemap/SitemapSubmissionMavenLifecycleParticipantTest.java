...
public class SitemapSubmissionMavenLifecycleParticipantTest {

	@Test
	public void doesNotRunWhenThereAreBuildErrors() throws Exception
	{
		SitemapSubmissionMavenLifecycleParticipant participant = new SitemapSubmissionMavenLifecycleParticipant();
